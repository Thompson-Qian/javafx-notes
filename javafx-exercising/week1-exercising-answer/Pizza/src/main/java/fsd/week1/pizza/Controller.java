...
public class Controller implements Initializable {
    ...
    @FXML
    private ChoiceBox<String> choices;//ChoiceBox里面需要填写类型

    @FXML
    private Label branchLabel;

    private String pizzaChoices[] = {"Cheese", "Peppers", "Tofu"};//定义一个名字为pizzaChoices的数组

    @FXML
    private ListView<String> myListView; //mylistview里面也要填写类型


    private String branches[] = {"Selly Oak", "Bournville", "Solihull"};//定义了一个名字为branches的数组
